...
use crate::rustdoc_parse::transform::utils::rust_code_block_iterator;
...
impl DocTransform for DocTransformRustMarkdownTag {
    ...
    fn transform(&self, doc: &Doc) -> Result<Doc, Infallible> {
        ...
        for item_or_other in rust_code_block_iterator(&doc.content).complete() {
            match item_or_other {
